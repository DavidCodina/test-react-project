...
const legendIcon = (
  ...
  >
    <path
      fill='#7c3aed'
      d='M8.5,10h-2C6.224,10,6,9.776,6,9.5v0C6,9.224,6.224,9,6.5,9h2C8.776,9,9,9.224,9,9.5v0
...
======================================================================== */
// In this case, I'm just hardcoding the name of the data set, rather than
// using the legend to map out each entry.value. Then I'm suing an additional
// label for that specific skill. This is a little hacky, but labels are easier
// to position than legends.

export const renderLegend = (_props: any) => {
  return (
    <div
