...
///////////////////////////////////////////////////////////////////////////
//
// Gotcha: Initially, I was doing this:
// import twColors from 'tailwindcss/colors'
//
//   export const colors = {...twColors,  brown: { ... } }
//
// This is actually what NativeWind recommends in their docs!
// The problem is that 'tailwindcss/colors' is actually an object of legacy colors,
// If you use it, React Native gives you a bunch of warnings.
// Instead, what you want to do is programatically generate a colors object based
// off of the Tailwind theme + your custom config
//
//   https://medium.com/pragmatic-programmers/access-tailwind-from-javascript-8e97f3c92ca6
//
...
// console.log(JSON.stringify(Object.keys(tailwindConfig?.theme), null, 2))
// console.log(JSON.stringify(tailwindConfig?.theme?.colors, null, 2))
// console.log(JSON.stringify(tailwindConfig?.theme?.fontSize, null, 2)) // rem units

///////////////////////////////////////////////////////////////////////////
//
// If you were NOT using Tailwind at all, you could manually create a colors object like this:
//
// export const colors = {
//   inherit: "inherit",
